...
const EN_FIX = [
  ...
  [/арахисовое молоко/i, 'glass of creamy peanut milk plant-based drink'],
  [/молоко/i, 'glass of milk'],
  [/рамен/i, 'ramen noodle soup bowl with egg and chashu'],
  [/трубач/i, 'noodle soup with seafood'],
